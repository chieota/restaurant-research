              ...
              <div class="card">
                  ...
                  <label >Country</label><br>
                    <select name="country">
                        ...
                        <option value="afghan">USA</option>
                        <option value="albanian">JAPAN</option>
                        <option value="algerian">SPAIN</option>
                        <option value="american">UE</option>
                        <option value="andorran">FRANCE</option>
                    </select>   
                  </div>
                      <div class="form-group">
